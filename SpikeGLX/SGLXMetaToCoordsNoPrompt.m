...
% Added the input argument for meta file name so prompt was no longer
% needed -DBH 8/9/2022
function SGLXMetaToCoordsNoPrompt(metaPath)
...
[path, fileName, fileExt] = fileparts(metaPath);
metaName = [fileName fileExt];
