function ops = ConfigureOpsKSDS(fPath, datName, chanMapName, batchSize)
...
datProps = datinfo(datName);
ops.NchanTOT = datProps.ChannelCount;
...
ops.reorder         = 0;       % whether to reorder batches for drift correction. 
